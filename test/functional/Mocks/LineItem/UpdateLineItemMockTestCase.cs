...
{
    public class UpdateLineItemMockTestCase : IMockRapidHttpClientTestCase
    {
        public bool IsMatch(HttpRequestMessage request)
        {
            return request.RequestUri.AbsolutePath.Contains("/crm-objects/v1/objects/line_items/9867220") && request.Method == HttpMethod.Put;
        }
