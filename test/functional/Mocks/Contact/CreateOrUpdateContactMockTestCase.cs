...
{
    public class CreateOrUpdateContactMockTestCase : IMockRapidHttpClientTestCase
    {
        public bool IsMatch(HttpRequestMessage request)
        {
            return request.RequestUri.AbsolutePath.EndsWith("/contact/createOrUpdate/email/that%40email.com");
        }
